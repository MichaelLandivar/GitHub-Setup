...
#Installing & Configuring Git
  ...
  #B. Configure Git on your computer
      #1. Open "Start" and search for "GitHub" and "Git Shell" (or any shell such as "Windows Power Shell x86")
  ...
  #D. Create New File > R Script
      ...
      #5. Select "Commit"
            #You will be prompted to enter your github.com credentials
